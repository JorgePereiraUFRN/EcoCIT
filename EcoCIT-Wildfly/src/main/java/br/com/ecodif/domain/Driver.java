...
public class Driver {
	...
	/** Localiza��o do <em>driver</em> no sistema de arquivos */
	@Column(name = "location_in_directory")
	...
	/**
	 * Retorna a localiza��o do <em>driver</em> no sistema de arquivos
	 * @return Localiza��o do <em>driver</em> no sistema de arquivos
	 */
	...
	/**
	 * Modifica a localiza��o do <em>driver</em> no sistema de arquivos
	 * @param locationInDirectory Localiza��o para altera��o
	 */
