...
/**
 * Classe de acesso a dados (DAO) da entidade de dom�nio Sensor que abstrai as opera��es sobre a respectiva 
...
public class SensorDAO extends GenericDAO<Sensor>{
	...
	public List<Sensor> findSensorsByDevice(int idDevice){
		...
		Device d = deviceDAO.find(idDevice);
	...
	/**
	 * Recupera um sensor com objetos do tipo Data segundo a descri��o do sensor
	 * @param description
	 * @return objeto do tipo Sensor
	 */
